...
import { SettingsComponent } from './components/jobseeker/settings/settings.component';
import { HelpSupportComponent } from './components/help-support/help-support.component';
import { EmployerSettingsComponent } from './components/employer/settings/settings.component';
...
export const routes: Routes = [
  ...
  // Shared help (accessible by all logged-in users)
  { 
    path: 'help', 
    component: HelpSupportComponent,
    canActivate: [AuthGuard]
